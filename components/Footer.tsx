  ...
  return (
    <footer className="flex flex-col text-gray-200 bg-gray-800 items-center gap-4 justify-center pt-2 pb-2">
      <div className="flex flex-row items-center justify-center gap-4 p-2">
        ...
        <form>
          <div className="flex flex-1 items-center justify-center space-x-2 bg-gray-200 shadow-xl rounded-xl border px-1 py-1 md:max-w-sm text-gray-800">
            <input
              type="text"
            ...
            />
            <EnvelopeIcon
              className="h-4 w-4 text-gray-800 hover:cursor-pointer"
